        ...
        private void StateUpdate(Entity entity)
        {
            ...
            switch (entity.State)
            {
                ...
                case STATE_TRIGGERED:
                    ...
                    {
                        // 碰到小车的僵尸受到伤害。
                        ent.TakeDamage(VanillaMod.INSTA_DAMAGE_AMOUNT, new DamageEffectList(VanillaDamageEffects.DAMAGE_BOTH_ARMOR_AND_BODY, VanillaDamageEffects.MUTE, VanillaDamageEffects.CART), entity);
