...
namespace MVZ2.Vanilla.Enemies
{
    ...
    public static class VanillaEnemyProps
    {
        ...
        #region 特殊行动
        public static readonly VanillaEntityPropertyMeta<bool> SPECIAL_MOVE = new VanillaEntityPropertyMeta<bool>("special_move");
        public static bool IsPerformingSpecialMove(this Entity enemy)
        {
            return enemy.GetProperty<bool>(SPECIAL_MOVE);
        }
        public static void SetPerformingSpecialMove(this Entity enemy, bool value)
        {
            enemy.SetProperty<bool>(SPECIAL_MOVE, value);
        }
        #endregion
