...
{
    [ArmorDefinition(VanillaArmorNames.skelebombCap)]
    public class SkelebombCap : ArmorDefinition
    {
        public SkelebombCap(string nsp, string name) : base(nsp, name)
        {
        ...
        public const float MAX_HEALTH = 270;
    }
}
