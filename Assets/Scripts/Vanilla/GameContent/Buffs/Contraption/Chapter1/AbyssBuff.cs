...
namespace MVZ2.GameContent.Buffs.Contraptions
{
    ...
    public class AbyssBuff : BuffDefinition
    {
        ...
        private void PostEntityDeathCallback(LevelCallbacks.PostEntityDeathParams param, CallbackResult result)
        {
            ...
            if (entity == null)
                return;
            if (!entity.HasBuff<AbyssBuff>())
                return;
            var buff = entity.GetFirstBuff<AbyssBuff>()!;
            var transformParam = new SpawnParams();
            transformParam.SetProperty(EngineEntityProps.FACTION, buff.GetProperty<int>(PROP_FACTION));
            entity.Spawn(VanillaEnemyID.gargoyle, entity.Position, transformParam);
            entity.PlaySound(VanillaSoundID.lightningAttack);
            entity.RemoveBuffs<AbyssBuff>();
        }
