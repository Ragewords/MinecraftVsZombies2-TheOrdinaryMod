...
{
    [BuffDefinition(VanillaBuffNames.Enemy.totenserWeb)]
    public class TotenserWebBuff : BuffDefinition
    {
        ...
        {
            base.PostAdd(buff);
            buff.SetProperty(PROP_TIMER, TimerHelper.NewSecondTimer(TRAP_SECONDS));
        }
        ...
        public const float TRAP_SECONDS = 15f;
