...
namespace MVZ2.GameContent.Buffs.Entities
{
    ...
    public class CursedCandleBuff : BuffDefinition
    {
        public CursedCandleBuff(string nsp, string name) : base(nsp, name)
        {
            ...
            AddModifier(new BooleanModifier(LogicEntityProps.REMOVE_ON_DEATH, PROP_REMOVE_EFFECT));
            AddModifier(new BooleanModifier(LogicEntityProps.NO_DEATH_EFFECTS, PROP_REMOVE_EFFECT));
        ...
        public override void OnCreate(Buff buff)
        {
            ...
            SetRemoveOnDeathEffect(buff, true);
        }
        public override void PostUpdate(Buff buff)
        {
            ...
            if (entity.ExistsAndAlive())
            {
                ...
                {
                    if (item.HasBuff(this))
                        continue;
                    var noExplosiveBuff = item.AddBuff(this);
                    SetNoExplode(noExplosiveBuff, true);
                    SetRemoveOnDeathEffect(noExplosiveBuff, false);
                    SetFireDamage(noExplosiveBuff, GetFireDamage(buff));
                }
            }
        }
        ...
        public static bool NoExplode(Buff buff) => buff.GetProperty<bool>(PROP_NO_EXPLODE);
        public static void SetNoExplode(Buff buff, bool value) => buff.SetProperty(PROP_NO_EXPLODE, value);
        public static void SetRemoveOnDeathEffect(Buff buff, bool value) => buff.SetProperty(PROP_REMOVE_EFFECT, value);
        public const float DAMAGE_INTERVAL_SECONDS = 1f;
        private Detector colllisionDetector = new CollisionDetector(true)
        {
        ...
        public static readonly VanillaBuffPropertyMeta<bool> PROP_NO_EXPLODE = new VanillaBuffPropertyMeta<bool>("no_explode");
        public static readonly VanillaBuffPropertyMeta<bool> PROP_REMOVE_EFFECT = new VanillaBuffPropertyMeta<bool>("remove_effect", true);
    }
}
