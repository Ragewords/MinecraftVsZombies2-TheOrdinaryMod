...
namespace MVZ2.GameContent.Buffs.Entities
{
    ...
    public class CursedCandleBuff : BuffDefinition
    {
        public CursedCandleBuff(string nsp, string name) : base(nsp, name)
        {
            ...
            AddModifier(new BooleanModifier(LogicEntityProps.REMOVE_ON_DEATH, PROP_REMOVES));
        ...
        public override void PostUpdate(Buff buff)
        {
            ...
            if (entity.ExistsAndAlive())
            {
                ...
                {
                    var hasNoExplosiveBuffs = item.GetBuffs(this).Any(b => NoExplode(b));
                    if (hasNoExplosiveBuffs)
                        continue;
                    var noExplosiveBuff = item.AddBuff(this);
                    SetNoExplode(noExplosiveBuff, true);
                    SetRemoveOnDeath(noExplosiveBuff, false);
        ...
        public static void SetRemoveOnDeath(Buff buff, bool value) => buff.SetProperty(PROP_REMOVES, value);
        ...
        public static readonly VanillaBuffPropertyMeta<bool> PROP_REMOVES = new VanillaBuffPropertyMeta<bool>("remove_effect", true);
    }
}
