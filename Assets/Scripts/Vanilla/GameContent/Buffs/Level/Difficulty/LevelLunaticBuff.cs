...
namespace MVZ2.GameContent.Buffs.Level
{
    ...
    public class LevelLunaticBuff : BuffDefinition
    {
        public LevelLunaticBuff(string nsp, string name) : base(nsp, name)
        {
            ...
            AddModifier(new FloatModifier(VanillaDifficultyLevelProps.WITHER_REGENERATION, NumberOperator.Set, 1f));
            ...
            AddModifier(new BooleanModifier(VanillaDifficultyLevelProps.LOCKED_CHEST_MEND_SELF, true));
