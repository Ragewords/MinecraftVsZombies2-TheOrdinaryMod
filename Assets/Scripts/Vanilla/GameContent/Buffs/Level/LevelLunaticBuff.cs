...
namespace MVZ2.GameContent.Buffs.Level
{
    ...
    public class LevelLunaticBuff : BuffDefinition
    {
        ...
        {
            AddModifier(new FloatModifier(VanillaLevelProps.CONVEY_SPEED, NumberOperator.Multiply, 0.75f));
            ...
            AddModifier(new FloatModifier(VanillaDifficultyProps.THE_EYE_DAMAGE_THRESOLD, NumberOperator.Add, -700f));
