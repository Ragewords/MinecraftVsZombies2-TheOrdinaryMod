...
namespace MVZ2.GameContent.Contraptions
{
    ...
    public class Pistenser : DispenserFamily
    {
        ...
        {
            var id = entity.GetBehaviourField<EntityID>(PROP_SUBTRACT_TARGET);
            if (id == null)
                return null;
            return id.GetEntity(entity.Level);
        }
        ...
        public static readonly VanillaEntityPropertyMeta<EntityID> PROP_SUBTRACT_TARGET = new VanillaEntityPropertyMeta<EntityID>("SubtractTarget");
