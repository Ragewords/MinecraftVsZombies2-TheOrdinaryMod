...
namespace MVZ2.GameContent.Contraptions
{
    ...
    public class Beacon : ContraptionBehaviour
    {
        ...
        public void UpdateDamageMultiplier(Entity entity)
        {
            var damageBuff = entity.GetFirstBuff(VanillaBuffID.Contraption.beaconDamage);
            if (damageBuff == null)
            {
                damageBuff = entity.AddBuff(VanillaBuffID.Contraption.beaconDamage);
            }
            var count = sphereDetector.DetectEntityCount(entity);
            BeaconDamageBuff.SetDamageMultiplier(damageBuff, count * DAMAGE_MULTIPLIER);
            BeaconDamageBuff.SetLightRangeAddtion(damageBuff, count * LIGHT_RANGE_MULTIPLIER);
        }
        ...
        public static readonly Vector3 LIGHT_RANGE_MULTIPLIER = Vector3.one * 10;
