...
namespace MVZ2.GameContent.Difficulties
{
    ...
    public static class VanillaDifficultyProps
    {
        ...
        public static readonly VanillaDifficultyPropertyMeta<float> CRESCENT_DAMAGE_THRESOLD = Get<float>("theEyeDamageThresold", 1700f);
        ...
        public static readonly VanillaDifficultyPropertyMeta<bool> SLENDERMAN_ALTERED_FATE = Get<bool>("slendermanAlteredFate");
        ...
        public static float GetCrescentDamageThresold(this LevelEngine level) => level.GetProperty<float>(CRESCENT_DAMAGE_THRESOLD);
        ...
        public static bool GetSlendermanAlteredFate(this LevelEngine level) => level.GetProperty<bool>(SLENDERMAN_ALTERED_FATE);
