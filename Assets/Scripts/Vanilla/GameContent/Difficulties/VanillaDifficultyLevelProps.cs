...
namespace MVZ2.GameContent.Difficulties
{
    ...
    public static class VanillaDifficultyLevelProps
    {
        ...
        public static readonly VanillaDifficultyPropertyMeta<bool> SLENDERMAN_MIND_SWAP_ERROR = Get<bool>("slendermanMindSwapError");
        ...
        public static bool SlendermanMindSwapError(this LevelEngine level) => level.GetProperty<bool>(SLENDERMAN_MIND_SWAP_ERROR);
        public static bool SlendermanAlteredFate(this LevelEngine level) => level.GetProperty<bool>(SLENDERMAN_ALTERED_FATE);
