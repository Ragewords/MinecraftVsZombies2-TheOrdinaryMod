...
namespace MVZ2.GameContent.Difficulties
{
    ...
    public static class VanillaDifficultyLevelProps
    {
        ...
        public static readonly VanillaDifficultyPropertyMeta<float> BLAZE_DAMAGE_MULTIPLIER = Get<float>("blazeDamageMultiplier", 1f);
        ...
        public static float GetBlazeDamageMultiplier(this LevelEngine level) => level.GetProperty<float>(BLAZE_DAMAGE_MULTIPLIER);
        ...
        public static readonly VanillaDifficultyPropertyMeta<bool> LOCKED_CHEST_MEND_SELF = Get<bool>("locked_chest_mend_self");
        ...
        public static bool LockedChestSelfMend(this LevelEngine level) => level.GetProperty<bool>(LOCKED_CHEST_MEND_SELF);
        ...
        public static bool UseLunaticProperty(this LevelEngine level) => level.GetProperty<bool>(USE_LUNATIC_PROPERTY);
