...
{
    [EntityBehaviourDefinition(VanillaEnemyNames.hypnotizer)]
    public class Hypnotizer : MeleeEnemy
    {
        public Hypnotizer(string nsp, string name) : base(nsp, name)
        {
        ...
        {
            base.Init(entity);
            entity.EquipArmor<HypnotizerHat>();
        ...
        public static readonly NamespaceID ID = VanillaEnemyID.hypnotizer;
