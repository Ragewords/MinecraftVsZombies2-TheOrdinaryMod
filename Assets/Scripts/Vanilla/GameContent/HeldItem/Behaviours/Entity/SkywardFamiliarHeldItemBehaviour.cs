...
{
    [HeldItemBehaviourDefinition(VanillaHeldItemBehaviourNames.skywardFamiliar)]
    public class SkywardFamiliarHeldItemBehaviour : EntityHeldItemBehaviour, IHeldTwinkleEntityBehaviour
    {
        public SkywardFamiliarHeldItemBehaviour(string nsp, string name) : base(nsp, name)
        {
        }
        ...
        public override void OnPointerEvent(IHeldItemTarget target, IHeldItemData data, PointerInteractionData pointerParams)
        {
            ...
            if (target is HeldItemTargetGrid targetGrid)
            {
                ...
                if (entity != null)
                {
                    SkywardOption.SetTargetColumn(entity, targetGrid.Target.Column);
                    SkywardOption.SetTargetLane(entity, targetGrid.Target.Lane);
