...
namespace MVZ2.GameContent.HeldItems
{
    ...
    public class SkywardFamiliarHeldItemBehaviour : EntityHeldItemBehaviour
    {
        ...
        public override void OnPointerEvent(IHeldItemTarget target, IHeldItemData data, PointerInteractionData pointerParams)
        {
            ...
            if (entity != null)
            {
                SkywardFamiliar.SetTargetColumn(entity, targetGrid.Target.Column);
                SkywardFamiliar.SetTargetLane(entity, targetGrid.Target.Lane);
