...
namespace MVZ2.GameContent.Models
{
    public static class VanillaModelID
    {
        ...
        public static readonly NamespaceID emeraldGrid = Get("emerald_grid", TYPE_GRID);
        ...
        public static readonly NamespaceID tntUnedited = Get("tnt_unedited", EngineModelID.TYPE_ENTITY);
        ...
        public static readonly NamespaceID glitched = Get("glitched", TYPE_ICON);
