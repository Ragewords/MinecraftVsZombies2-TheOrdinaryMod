...
namespace MVZ2.GameContent.Models
{
    public static class VanillaModelID
    {
        ...
        public static readonly NamespaceID paratrooperZombie = Get("paratrooper_zombie", EngineModelID.TYPE_ENTITY);
        ...
        public static readonly NamespaceID totenserWeb = Get("totenser_web", TYPE_ICON);
        ...
        public static readonly NamespaceID levitationStars = Get("levitation_stars", TYPE_ICON);
