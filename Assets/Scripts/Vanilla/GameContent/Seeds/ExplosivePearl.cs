...
{
    [SeedOptionDefinition(VanillaBlueprintNames.explosivePearl)]
    public class ExplosivePearl : SeedOptionDefinition
    {
        ...
        private void Use(LevelEngine level)
        {
            ...
            if (board == null)
                return;
            var pearl = BreakoutBoard.SpawnPearl(board);
            pearl.AddBuff<ExplosivePearlBuff>();
